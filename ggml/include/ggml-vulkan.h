...
// should then use ggml_backend_tensor_get as before.
GGML_API GGML_CALL bool ggml_backend_vk_arm_readback(ggml_backend_t backend, const struct ggml_tensor * tensor,
